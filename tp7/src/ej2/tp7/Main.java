...
public class Main { 
    ...
    public static void main(String[] args) { 
        ...
        Libro[] libro = new Libro[datos.length];

        for (int i = 0; i < datos.length; i++) {
            libro[i] = new Libro(datos[i][0],datos[i][1], Integer.parseInt(datos[i][2]));
        }
        ...
        System.out.println("Inventario de la Biblioteca: " + biblioteca.cantidadLibros());
    } 
}